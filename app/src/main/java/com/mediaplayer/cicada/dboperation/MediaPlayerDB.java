package com.mediaplayer.cicada.dboperation;
...
import com.mediaplayer.cicada.view.adapters.SongsListAdapter;
...
public class MediaPlayerDB {
    private static SQLiteDatabase db;
    private MediaPlayerDBHelper mDbHelper;
    private Context context;

    public MediaPlayerDB(Context context) {
